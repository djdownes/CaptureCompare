...
#######################################################################################
#                                                                                     #
# You can fill the below, to match your public area and server setup                  # 
# OR                                                                                  #
# copy the serverAddressAndPublicDiskSetup.sh file from your CCseqBasic installation  #
# to become the /config/serverAddressAndPublicDiskSetup.sh file of CaptureCompare     #
#                                                                                     #
